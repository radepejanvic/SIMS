...
namespace Library.Model
{
    public class Room : ISerializable
    {
        ...
        public void IncreaseStaticEquipmentQuantity(int quantity, StaticEquipmentType type)
        {
            StaticEquipmentBook.FirstOrDefault(r => r.Type == type).Quantity += quantity;
        ...
        public void DecreaseStaticEquipmentQuantity(int quantity, StaticEquipmentType type)
        {
            StaticEquipmentBook.FirstOrDefault(r => r.Type == type).Quantity -= quantity;
